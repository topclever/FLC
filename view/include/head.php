...
// tempcode getTheme from session
if (!isset($_COOKIE['theme'])) {
    $theme = 'spacelab';
    // setcookie("theme", "spacelab");
...
<link href="<?php echo $global['webSiteRootURL']; ?>view/bootstrap/bootstrapSelectPicker/css/bootstrap-select.min.css" rel="stylesheet" type="text/css" />
<link href="<?php echo $global['webSiteRootURL']; ?>view/js/bootgrid/jquery.bootgrid.css" rel="stylesheet" type="text/css" />
<link href="<?php echo $global['webSiteRootURL']; ?>view/js/jquery-toast/jquery.toast.min.css" rel="stylesheet" type="text/css" />

<?php
// tempcode this part dont work on server
// $cssFiles = array();
...
echo "<!-- current theme is " . $theme . " start-->";
...
?>
    <link href="<?php echo $global['webSiteRootURL']; ?>view/css/custom/spacelab.css" rel="stylesheet" type="text/css" />
<?php } ?>
