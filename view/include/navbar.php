...
?>
                    ...
                    <li style="max-width: 40px;">
                        ...
                        <script>
                            function YPTSidebarOpen() {
                                ...
                                console.log('youTubeMenuIsOpened==>', true)
                            }
                            ...
                            function YPTSidebarClose() {
                                ...
                                console.log('youTubeMenuIsOpened==>', false)
                            }
                            $(document).ready(function() {
                                // tempcode 14.sidebar
                                youTubeMenuIsOpened = Cookies.get('youTubeMenuIsOpened');
                                console.log('youTubeMenuIsOpened', youTubeMenuIsOpened)
                                if ($(window).width() < 767) {
                                    YPTSidebarClose();
                                } else {
                                    if (youTubeMenuIsOpened == true || youTubeMenuIsOpened == 'true') {
                                        YPTSidebarOpen();
                                        console.log('youTubeMenuIsOpened==>1', true)
                                    } else {
                                        YPTSidebarClose();
                                    }
                                }
                                ...
                                $('#buttonMenu').on("click.sidebar", function(event) {
                                    ...
                                    if ($('body').hasClass('youtube')) {
                                        ...
                                        YPTSidebarOpen();
                                        console.log('youTubeMenuIsOpened==>2', true)
                                    }
                                ...
                                $(window).resize(function() {
                                    if ($(window).width() > 767) {
                                        ...
                                        // tempcode 14.sidebar
                                        if (youTubeMenuIsOpened == true) {
                                            YPTSidebarOpen();
                                            console.log('youTubeMenuIsOpened==>3', true)
                                        }
                    ...
                    ?>
                        <li>
                            <a class="navbar-brand" href="<?php echo User::getChannelLinkFromChannelName($_SESSION['channelName']); ?>">
                                <img src="<?php echo User::getPhoto($user['id']); ?>" alt="<?php echo User::getNameIdentificationById($user['id']); ?>" class="img img-circle " style="height: 33px; width: 33px; margin-right: 15px;">
                            </a>
                        </li>
                    <?php } ?>
            ...
            <li style="margin-right: 0px; padding-left: 0px;" id="navbarRegularButtons">
                <div class="hidden-xs" id="myNavbar">
                    <ul class="right-menus" style="padding-left: 0;">
                                                ...
                                                ?>
                                                    <li>
                                                        <form id="formEncoder" method="post" action="<?php echo $config->getEncoderURL(); ?>" target="encoder" autocomplete="off">
                                                            ...
                                                            <input type="hidden" name="webSiteRootURL" value="<?php echo $global['webSiteRootURL']; ?>" autocomplete="off" />
                                                            <input type="hidden" name="user" value="<?php echo User::getMail(); ?>" autocomplete="off" />
                                                            <input type="hidden" name="pass" value="<?php echo User::getUserPass(); ?>" autocomplete="off" />
                                                            <input type="hidden" name="isAdmin" value="<?php echo User::isAdmin(); ?>" autocomplete="off" />
                                                        </form>
                        ...
                        <!-- explorerr dark mode -->
                        <li>
                            <div data-toggle="tooltip" title="<?php echo __('Change Theme'); ?>" data-placement="bottom">
                                <select class="btn btn-default navbar-btn btn-md dropdown-toggle selecttheme" id="selecttheme" name="selecttheme" style="height:37px;">
                                    <option value="spacelab" <?php if(isset($_COOKIE['theme']) && $_COOKIE['theme'] == "spacelab") echo "selected"; ?>><?php echo __("Light"); ?></option>
                                    <option value="cyborg" <?php if(isset($_COOKIE['theme']) && $_COOKIE['theme'] == "cyborg") echo "selected"; ?>><?php echo __("Dark"); ?></option>
                                </select>
                            </div>
                            <script>
                                $("#selecttheme").change(function() {
                                    document.cookie = "theme="+$(this).val();
                                    // $.removeCookie("theme");
                                ...
                                <div class="btn-group">
                                    ...
                                    ?>
                                        <button type="button" class="btn btn-default  dropdown-toggle navbar-btn pull-left" data-toggle="dropdown" id="rightProfileButton" style="min-height:34px;">
                                            <img src="<?php echo User::getPhoto(); ?>" style="width: 32px; height: 32px; max-width: 32px;" class="img img-responsive img-circle" alt="User Photo" />
                                        </button>
                ...
                <ul class="nav navbar">
                    ...
                    if (empty($advancedCustomUser->doNotShowLeftProfile)) {
                        ...
                        ?>
                            ...
                            <li>
                                <h2 class="text-danger"><?php echo ucwords($t['My Menu']); ?></h2>
                                ...
                                ?>
                                    <div>
                                        <a href="<?php echo $global['webSiteRootURL']; ?>logoff" class="btn btn-default btn-block">
                                            ...
                                            ?>
                                            <i class="fas fa-sign-out-alt"></i> <?php echo ucwords(__("Sign out")); ?>
                                        </a>
                                    </div>
                                <?php
                                }
                    ...
                    if (empty($advancedCustom->doNotDisplayCategoryLeftMenu)) {
                        ...
                        foreach ($categories as $value) {
                            ...
                            echo '<image style="margin-top:-5px" src="' . (empty($value['iconClass']) ? $global['webSiteRootURL'] . "view/img/player.png" : $global['webSiteRootURL'] . $value['iconClass']) . '" width=16 height=16 />   ' . $value['name'];
                    ...
                    <!-- tempcode 16.subscriptions -->
                    <?php
                    if (User::getId()) { ?>
                        <li>
                            <h3 class="text-danger"><?php echo __('My Subscribers'); ?></h3>
                        </li>
                        <?php
                        $mchannels = Channel::getMyChannels(User::getId());
                        // print_r($channels);
                        $count = 0;
                        $nlimit = 7;
                        $allCount = count($mchannels);

                        if ($allCount > $nlimit) {
                            for ($count = 0; $count < $nlimit; $count++) {
                                echo '<li class="navsub-toggle">'
                                    . '<a href="' . $global['webSiteRootURL'] . 'channel/' . $mchannels[$count]['channelName'] . '" >';
                                echo ('<span class="fas fa-play-circle">') . '</span>';
                                echo "&nbsp;" . $mchannels[$count]['channelName'];
                                echo '</a>';
                                echo '</li>';
                            }
                        ?>
                            ...
                            <?php
                            // echo ("<span id='smore'>");
                            for ($count = $nlimit; $count < $allCount; $count++) {
                                echo '<li class="navsub-toggle shows" id="smore">'
                                    . '<a href="' . $global['webSiteRootURL'] . 'channel/' . $mchannels[$count]['channelName'] . '" >';
                                echo ('<span class="fas fa-play-circle">') . '</span>';
                                echo "&nbsp;" . $mchannels[$count]['channelName'];
                                echo '</a>';
                            ...
                            ?>
                            <li>
                                <a href="<?php echo $global['webSiteRootURL']; ?>schannels">
                                    <i class="fa fa-plus-circle"></i>
                                    <?php echo __("Browse Channels"); ?>
                                </a>
                            </li>
                            <li class="navsub-toggle">
                                <a onclick="showMore()" id="smyBtn" style="cursor: pointer;">
                                    <span class="fa fa-angle-down"></span>
                                    &nbsp; <?php echo __("Show more channels"); ?>
                                </a>
                            </li>
    ...
    <script>
        ...
        // tempcode 16.subscriptions expand/collapse
        function showMore() {
            var sdots = document.getElementById("sdots");
            var smoreText = document.getElementById("smore");
            var sbtnText = document.getElementById("smyBtn");
            console.log(smoreText.style.display);

            if (sdots.style.display === "none") {
                sdots.style.display = "inline";
                sbtnText.innerHTML = ' <span class="fa fa-angle-down"></span> ' +
                    '&nbsp; <?php echo __("Show more channels"); ?>';
                smoreText.style.display = "none";
            } else {
                sdots.style.display = "none";
                sbtnText.innerHTML = ' <span class="fa fa-angle-up"></span> ' +
                    '&nbsp; <?php echo __("Collapse"); ?>';
                smoreText.style.display = "inline";
            }
        }
    </script>
<?php
