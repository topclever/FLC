    ...
    <div class="col-xs-12 col-sm-8  col-md-6 col-lg-4 list-group-item ">
        <fieldset>
            ...
            if (empty($advancedCustomUser->disableNativeSignIn)) {
                ?>
                <form class="form-compact well form-horizontal"  id="loginForm" method="post">
                    <input type="hidden" name="redirectUri" value=""/>
                    <div class="form-group">
                        <label class="col-sm-4 control-label hidden-xs" style="padding-left: 0"><?php echo __("Email"); ?></label>
                    ...
                    <!-- <div style="text-align:center;">
                        ...
                        <span><?php echo __('Please enter the answer in Arabic number');?></span> 
                    </div> -->
                    <?php
                    // $captcha = User::getCaptchaForm();
                    ?>
                    <div class="form-group captcha" id="captchaForm">
                        <?php //echo $captcha; ?>
                        <div class="g-recaptcha" style="display: flex; justify-content:center; padding-bottom:20px;" data-sitekey="6LdVHtgZAAAAAHu5eBZyFXZtEBro25ApuaPy20DD">
                    </div>
                    <div class="form-group">
...
?>
            ...
            $.ajax({
                ...
                data: {"user": $('#inputUser').val(), "pass": $('#inputPassword').val(), "g-recaptcha-response": $('#g-recaptcha-response').val(), "rememberme": $('#inputRememberMe').is(":checked"), "captcha": $('#captchaText').val(), "redirectUri": "<?php print isset($_GET['redirectUri']) ? $_GET['redirectUri'] : ""; ?>"},
                type: 'post',
