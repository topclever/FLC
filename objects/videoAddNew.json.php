...
$obj->setSourcesLink(json_decode(@$_POST['sourcesArray']), @$_POST['users_id'], @$_POST['id']);

// $obj->setInputLinkTitle(@$_POST['inputLinkTitle']);
// $obj->setInputLinkAddress(@$_POST['inputLinkAddress']);
...
// tempcode sources htmllink check videoTags->saveVideosAddNew() getting error
// related to Tag
