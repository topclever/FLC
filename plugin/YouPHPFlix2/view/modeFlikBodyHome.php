<?php
// tempcode featured video mychannel home tab body
...
// should determin if the user is premium for featured video
$video = false;
// echo "tempcode-userid".$user->getId();
if ($user->isPremiumUser($user->getId()))
    $video = Video::getPremiumFeaturedVideo(null, "", true, false, false, true);
else
    $video = Video::getStandardFeaturedVideo(null, "", true, false, false, true);
if (!$video)
    $video = Video::getMostWatchedVideo(null, "", true, false, false, true);
// print_r($video);
...
<div class="row" id="mvideo">
    <div class="col-sm-5 col-md-5 secC">
        <div id="videoContainer">
            ...
            <div id="main-video" class="embed-responsive <?php echo $embedResponsiveClass; ?>">
                <video playsinline webkit-playsinline="webkit-playsinline" <?php if ($config->getAutoplay() && false) { // disable it for now   
                                                                            ?> autoplay="true" muted="muted" <?php } ?> preload="auto" poster="<?php echo $poster; ?>" controls class="embed-responsive-item video-js vjs-default-skin <?php echo $vjsClass; ?> vjs-big-play-centered" id="mainVideo">
    ...
    <div class="col-sm-7 col-md-7">
        <div style="position: relative;
            ...
            touch-action: auto; ">
            <div style="width: 100%; height: 345px;display: flex;
            ...
            player.ready(function() {
                ...
                ?>
                    setTimeout(function() {
                        ...
                        // tempcode disable autoplay in featured video
